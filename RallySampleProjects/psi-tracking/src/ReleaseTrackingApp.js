(function()
{
    ...
    Ext.define('Rally.apps.releasetracking.ReleaseTrackingApp', {
            ...
            _getGridStore : function()
            {
                ...
                config.filters = [
                    context.getTimeboxScope().getQueryFilter()
                ];
            ...
            {
                var isPillPickerEnabled = context.isFeatureEnabled('BETA_TRACKING_EXPERIENCE'), projectRef = context.getProjectRef();
            ...
            {
                var context = this.getContext(), stateString = 'release-tracking', stateId = context.getScopedStateId(stateString);
                var gridConfig = {
                        xtype : 'rallytreegrid',
                        store : gridStore,
                        // enableRanking:
