    ...
    Ext.define('Rally.apps.charts.burndown.BurnDownApp', {
            ...
            _renderChartBasedOnType : function()
            {
                ...
                } else
                {
                    ...
                    { // wait until we get the schedule states
            ...
            _addDateBoundsToCalculator : function()
            {
                ...
                // S53625: If the time-box has ended, disable the projection
                // line
            ...
            _getNearestWorkday : function(categories, date)
            {
                ...
                if (index === -1)
                {
                    ...
                    // date not in categories (probably) means it falls on a
                    // non-workday...back up to the next previous workday
            ...
            {
                var pixelTickWidth = 125, appWidth = this.getWidth(), ticks = Math.floor(appWidth / pixelTickWidth);
            ...
            {
                var chartAggregationType = this.getSetting('chartAggregationType'), chartDisplayType = this.getSetting('chartDisplayType'), chartTimebox = this.getSetting('chartTimebox');
