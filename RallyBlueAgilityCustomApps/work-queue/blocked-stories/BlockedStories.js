Ext.define('BlockedStories', {
        ...
        {
            console.log("Blocked stories: got release change", release, this.currentTimebox);
            if (release !== null)
            {
                ...
                // } else
                // {
                // console.log("Blocked stories: Release change message, no
                // change");
                // }
            }
        },
        ...
        {
            console.log("Blocked stories: got iteration change", iteration, this.currentTimebox);
            if (iteration !== null)
            {
                ...
                // } else
                // {
                // console.log("Blocked stories: iteration change message, no
                // change");
                // }
            }
        }
