...
Ext
		.define(
				'Rally.apps.releasetracking.statsbanner.AcceptedCount',
				{
					...
					alias : 'widget.statsbanneracceptedcount',
					requires : [ 'Rally.util.Colors' ],

					tpl : [
							'<div class="expanded-widget">',
							'<div class="stat-title">Accepted Stories by Count</div>',
					...
					_getChartConfig : function(renderData) {
						...
						return { chartData : { series : [ { data : [
								{ name : 'Accepted Stories by Count', y : percentage, color : color },
								{ name : '', y : 100 - percentage, color : Rally.util.Colors.grey1 } ] } ] } };
					} });
