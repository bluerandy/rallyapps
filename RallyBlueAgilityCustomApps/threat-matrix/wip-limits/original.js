Ext.define('Rally.apps.kanban.KanbanApp', {
        ...
        config : {
            defaultSettings : {
                    ...
                    cardFields : 'FormattedID,Name,Owner,Discussion,Tasks,Defects', // remove
                    // with
                    // COLUMN_LEVEL_FIELD_PICKER_ON_KANBAN_SETTINGS
         ...
         * 
         * @protected
         * @param {Rally.app.TimeboxScope}
         *            timeboxScope The new scope
         */
        ...
        {
            var context = this.getContext(), modelNames = this._getDefaultTypes(), blacklist = [
                            'Successors',
                            'Predecessors',
                            'DisplayColor'
            ];
        ...
        {
            this._showReportDialog('Cycle Time Report', this._buildReportConfig(Rally.ui.report.StandardReport.Reports.CycleLeadTime));
        },
        _showThroughputReport : function()
        {
            this._showReportDialog('Throughput Report', this._buildReportConfig(Rally.ui.report.StandardReport.Reports.Throughput));
        },
        _print : function()
        {
            this.gridboard.getGridOrBoard().openPrintPage({
                title : 'Kanban Board'
            });
        },
        _getWorkItemTypesForChart : function()
        {
            var types = this.gridboard.getGridOrBoard().getTypes(), typeMap = {
