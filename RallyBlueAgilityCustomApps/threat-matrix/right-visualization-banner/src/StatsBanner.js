Ext.define('RightStatsBanner', {
        extend : 'Ext.Container',
        alias : 'RightStatsBanner',
        requires : [
        ...
        initComponent : function()
        {
            this.addEvents(
            /**
             * @event Fires when expand is clicked
             */
            'expand',
            /**
             * @event Fires when collapse is clicked
             */
            'collapse');
            ...
            // need to configure the items at the instance level, not the
            // class level (i.e. don't use the 'defaults' config)
